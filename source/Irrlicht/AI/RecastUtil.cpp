	...
	RecastUtil* RecastUtil::recast = 0;
    ...
    bool RecastUtil::getMeshDataFromPolyMeshDetail ( rcPolyMeshDetail* dmesh,  std::vector<float>& vertsOut, int& nvertsOut,   std::vector<int>& trisOut, int& ntrisOut)
        {
        ...
        bool RecastUtil::setMeshBufferData ( scene::SMeshBuffer& buffer, const std::vector<float>& verts, int& nverts, const std::vector<int>& tris, int& ntris)
        {
            //TODO:
            // err handling:
        ...
        //Detour stuff
        vector<irr::core::vector3df> RecastUtil::returnPath(core::vector3df *pStart, core::vector3df *pEnd)
        {
            ...
            if (m_navQuery)
            {
                ...
                if (m_startRef == 0)
                {
					printf("returnPath(): invalid start point\n");
                    return lstPoints;
                ...
                if (m_endRef == 0)
                {
					printf("returnPath(): invalid end point\n");
                    return lstPoints;
                }
                ...
                if (pathCount > 0)
                {
                    ...
                    {
                        vector3df cpos(m_straightPath[i * 3], m_straightPath[i * 3 + 1] + 0.25f,
